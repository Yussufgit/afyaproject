<?php
 ...
 <?php
    function mailUser($email,$hash)
    {
        ...
        $header="From:yussufmohamed@gmail.com"."\r\n".
                "CC: kennbeckloff688@gmail.com";
        $message="Click the link below to activate your account\n\n http://localhost/healthcare/confirmMail.php?email=$email&hash=$hash";
    ...
    if (array_key_exists("submit", $_POST)) {
        ...
        if ($error == "") {                           
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $user_type = '0'; //default
                    $query = "INSERT INTO `users` (`username`,`email`, `password`,`hash`,`avatar`,`user_type`) VALUES ('".mysqli_real_escape_string($conn, $_POST['username'])."','".mysqli_real_escape_string($conn, $_POST['email'])."', '".mysqli_real_escape_string($conn, $_POST['password'])."','".mysqli_real_escape_string($conn, $hash)."','$image','$user_type')";
